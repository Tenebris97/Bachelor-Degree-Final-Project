...
namespace FinalProject.Areas.User.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Profile(IndexViewModel model)
        {
            ...
            applicationUser.NationalCode = model.NationalCode;
            applicationUser.Gender = model.Gender;
            applicationUser.MobileNumber = model.MobileNumber;
        ...
        public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
        {
            ...
            StatusMessage = "تایید ایمیل ارسال شد. لطفا ایمیل خود را چک کنید";
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            StatusMessage = "رمزعبور با موفقیت تغییر کرد";
